...
func TestEditFile(t *testing.T) {
	...
	t.Run("multiple operations", func(t *testing.T) {
		...
		readTool := NewReadFileTool(fs, newMockBinaryDetectorForWrite(), checksumManager, config.DefaultConfig(), workspaceRoot)
		editTool := NewEditFileTool(fs, newMockBinaryDetectorForWrite(), checksumManager, config.DefaultConfig(), workspaceRoot)
	...
	t.Run("binary file rejection", func(t *testing.T) {
		...
		editTool := NewEditFileTool(fs, detector, checksumManager, config.DefaultConfig(), workspaceRoot)
